...
public class AcercaDe extends JFrame implements ActionListener{
	...
	public AcercaDe() {
		...
		JLabel lblAño = new JLabel("2023");
		lblAño.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblAño.setBounds(193, 159, 34, 25);
		contentPane.add(lblAño);
		
		btnCerrar = new JButton("Cerrar");
		btnCerrar.addActionListener(this);
		btnCerrar.setBounds(165, 188, 89, 23);
		...
		lblAutores.setBounds(182, 46, 55, 39);
		contentPane.add(lblAutores);
		
		JLabel lblNewLabel = new JLabel("Michel Torres Landeo");
		lblNewLabel.setBounds(154, 94, 138, 14);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Emilio Cabrera");
		lblNewLabel_1.setBounds(173, 119, 108, 14);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setBounds(181, 144, 73, 14);
